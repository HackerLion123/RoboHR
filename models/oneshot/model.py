...
"""
	Most of this code is taken from https://github.com/chen0040/keras-face
	I changed certain parts of implementation
"""
...
class SiameseNet(object):
	...
	def evalute(self,test,labels):
		...
		print("hello")
		self.model.evaluate([t_x[:,0],t_x[:,1]],t_y,verbose=1)
...
def main():
	...
	model.fit(database=np.load('database.npy').item(),epochs=900)
	model.load_model()
